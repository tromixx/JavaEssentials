...
public class Generics {
	...
	public static void main(String[] args)
	{
		BankAccount obj1 = new BankAccount("XYZ", "ACT000001");
		obj1.showMenu();
...
class BankAccount
{
	...
	void getPreviousTransaction()
	{
		...
		{
			System.out.print("Withraw: "+ Math.abs(previousTransaction));
		}
		else
		{
	...
	void showMenu()
	{
		...
		System.out.println("C.Withrdraw");
		...
		do
		{
			...
			System.out.println("Tank you for using our system");
